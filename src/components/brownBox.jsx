const BrownBox = ({first, sec}) =>{
    return(
        <div className="w-full hover:scale-110 hover:shadow-md md:w-[228px] h-[118px] md:h-[158px] bg-[#222222] gap-5  rounded-3xl flex flex-col justify-center items-center">
