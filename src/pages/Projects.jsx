const Projects = () =>{
    return(
        <div className="w-full bg-[#0F0F0F] justify-center items-center p-[32px] ">
            <h3 className="bg-gradient-to-r to-[#4ADE80] font-bold pt-[122px] from-[#ffffff] gradient-text text-[48px] w-full text-center">Featured Projects</h3>
                            {/* desktop view */}
            <div className="lg:flex hidden lg:h-[407px] lg:w-full mt-[47px] ">   
                <div className="bg-[#222222] rounded-l-[24px] p-[49px] h-[405px] border- w-full">
                    <div className="w-full flex items-center justify-start gap-2">
                        <p className="bg-[#4ADE80] w-[12px] h-[12px] rounded-[6px]"></p>
                        <p className="text-[#999999]">Featured Project</p>
                    </div>
                    <p className="text-white font-bold text-[30px] mt-[24px] mb-[28px]">Social Media Dashboard</p>
                    <p className="text-[#999999] mb-[27px]" >Analytics dashboard for social media management with real-time data visualization</p>
                    <p className="text-[#999999] mb-[33px] text-[16px]" ><span className="text-[#4ADE80] font-semibold text-[16px]">Technologies:</span> React native, Redux</p>
                    <div className="flex w-[310px] gap-[24px]">
                        <div className="text-center flex items-center justify-center font-semibold hover:scale-110 hover:border-[2px] w-full h-[52px] rounded-[12px] bg-gradient-to-r to-[#4ADE80] from-[#ffffff] text-black ">View Live</div>
                ...
                <div className="w-full bg-[#4ADE80] h-[405px] flex  justify-center items-center pt-[175px]">
                    <p className="text-4xl font-bold text-black  h-full text-center  ">Dashboard App</p>
                </div>
            ...
            <div className="lg:flex lg:gap-[32px] ">
                <div className="w-full h-[405px] text-white pt-[32px] bg-[#222222] rounded-[24px] p-[16px] overflow-auto mb-[24px] lg:mb-0">
                    ...
                    <p className="w-full text-[18px] pt-[30px]  border-b-[0.2px] pb-[12px] border-[#333333] flex justify-between"> <span>Fintech Web App</span> <span className="text-green-300">React.js</span></p>
                    <p className="w-full text-[18px] pt-[30px]  border-b-[0.2px] pb-[12px] border-[#333333] flex justify-between"> <span>Connection Platform</span> <span className="text-green-300">Full stack</span></p>
                ...
                <div className="w-full h-[405px] text-white bg-[#222222] rounded-[24px] p-[32px] ">
                    ...
                    <p className="w-full text-[18px] pt-[12px] pb-[12px] flex justify-between"> <span className="text-[#999999]">Public Repos </span> <span className="text-white font-bold">38</span></p>
                    <p className="w-full text-[18px] pt-[12px] pb-[12px] flex justify-between"> <span className="text-[#999999]">Total Stars</span> <span className="text-white font-bold">1,278</span></p>
                    <p className="w-full text-[18px] pt-[12px] pb-[12px] flex justify-between"> <span className="text-[#999999]">Followers</span> <span className="text-white font-bold">978</span></p>
                    <p className="w-full text-[18px] pt-[12px] pb-[12px] flex justify-between"> <span className="text-[#999999]">Contributions</span> <span className="text-white font-bold">2,156</span></p>
                    <div className="w-full flex justify-center items-center">
                        <button className="bg-[#333333] lg:w-[310px] lg:h-[60px] h-[48px] w-full  rounded-[12px] mt-[20px] hover:border-2">View GitHub Profile</button>
                    </div>
                </div>
