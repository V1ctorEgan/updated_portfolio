...
const Technical = () =>{
    return(
        <div name="skills" className="bg-[#111111] flex pb-[128px] justify-center items-center p-[16px] flex-col pt-[112px]">
            ...
            <div className="bg-[#222222] pl-[51px] mt-[37px]  pt-[45px] pb-[45px] pr-[51px] lg:w-[577px] lg:h-[106px] w-full lg:rounded-[24px] rounded-[16px] justify-center items-center ">
                <div className=" w-full  bg-gradient-to-r rounded-[10px] animate-pulse to-[#4ADE80] from-[#ffffff] border h-[16px]"></div>
            </div>
